...
export let users: any[] = [
  ...
  },
  {
    ...
    email: 'head@head.edu',
    password: hashPasswordSync('Head@123!'),
    phone: '+251 948822471',
    employeeId: 'DHD-201',
    role: 'DEPT_HEAD',
    status: 'ACTIVE',
  ...
  },
  {
    ...
    assignedCourseIds: ['crs-104', 'crs-102'],
  ...
  },
  {
    ...
    status: 'ACTIVE',
    department: 'ህጻናት እና አዳጊ',
    assignedClassIds: ['cls-3', 'cls-4'],
    assignedCourseIds: ['crs-201', 'crs-202'],
    canAccessAllClasses: false,
  ...
  },
  {
    ...
    password: hashPasswordSync('Coordinator@123!'),
  ...
  },
  {
    id: 'usr-6',
    name: 'Abel Tesfaye',
    amharicName: 'አቤል ተስፋዬ',
    email: 'student1@amras.edu',
    password: hashPasswordSync('Student@123!'),
    phone: '+251 911 234501',
    employeeId: 'ST-2026-001',
    role: 'STUDENT',
    status: 'ACTIVE',
    department: 'ደረጃ 1 - ሉቃስ',
...
export const defaultBehavioralNotes: any[] = [
  {
    ...
    isFlag: true,
    flagType: 'MERIT_COMMENDATION',
    flagStatus: 'ACTIVE',
    flagPriority: 'LOW',
    shortWarningNote: 'Exemplary leadership award nomination for Sunday liturgy and choral singing.',
    tags: ['Choir', 'Leadership', 'SpiritualDedication'],
  ...
  },
  {
    ...
    flagStatus: 'ACTIVE',
    flagPriority: 'LOW',
    shortWarningNote: 'Perfect punctuality and exemplary church ethics recognition.',
    tags: ['Punctual', 'Honors'],
  ...
  },
  {
    ...
    flagStatus: 'ACTIVE',
    flagPriority: 'HIGH',
    shortWarningNote: 'Repeated Sunday morning tardiness (15+ min late). Requires coordinator check-in.',
    tags: ['Tardiness', 'AttendanceAlert', 'ParentNoticeNeeded'],
  ...
  },
  {
    ...
    followUpRequired: true,
    isFlag: true,
    flagType: 'ACADEMIC_ALERT',
    flagStatus: 'RESOLVED',
    flagPriority: 'MEDIUM',
    shortWarningNote: 'Midterm study revision assistance agreed with peer mentor.',
    resolutionNotes: 'Completed 2 tutor sessions with student peer mentor; quiz scores improved to 88%.',
    resolvedAt: '2026-08-10T15:30:00Z',
    resolvedByUserId: 'usr-2',
    resolvedByUserName: 'Biruk Wendemeneh',
    tags: ['Tutoring', 'AcademicImprovement'],
